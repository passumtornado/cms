...
if(isset($_POST['submit_cook'])){
    ...
    if(count($error)==0){
        ...
        $cook_query ="SELECT * FROM cook WHERE username = '$username' AND password='$password'";
        $cook_result = mysqli_query($db,$cook_query);
        if(mysqli_num_rows($cook_result)==1){
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6">
                    <h2 style="color: white">COOK LOGIN</h2>
                    <img src="images/images%20(2).jpg"class="img-circle" alt="" >
                </div>
                <div class="col-lg-3 col-md-3"></div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <form action="" method="post">
                    <div class="col-lg-6 col-md-6">
                        ...
                        <button type="submit" class="btn btn-primary" name="submit_cook"><span class="glyphicon glyphicon-log-in" aria-hidden="true"></span> Login</button>
