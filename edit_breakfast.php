...
if(isset($_GET['editID'])){
     ...
     $edit_break = $_GET['editID'];
}
 $query= "SELECT * FROM breakfast WHERE bID= $edit_break ";
...
if(isset($_POST['update_break'])){
    ...
    $query_update = "UPDATE breakfast SET foodName= '$foodname',quantity='$quantity',amount='$price',description='$description',
                    foodtags='$foodtags',image='$upload_image' WHERE bID = $edit_break";
            ...
            <form action=" " method="post" enctype="multipart/form-data">
                ...
                <div class="col-lg-6 col-md-6">
                   <h3 class="page-header" style="text-align:center;"> UPDATE FOOD </h3>
                    ...
                    <button type="submit" id="addfood" class="btn btn-primary" name="update_break"><span class="glyphicon glyphicon-log-in"></span> Update</button>
                </div>
            </form>
