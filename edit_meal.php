...
if(isset($_GET['editID'])){
     ...
     $edit_menu = $_GET['editID'];
}
 $query= "SELECT * FROM menu WHERE m_ID= '$edit_menu' ";
...
if(isset($_POST['update_menu'])){
    ...
    $query_update = "UPDATE menu SET foodName= '$foodname',quantity='$quantity',amount='$price',description='$description',
                    foodtags='$foodtags',image='$upload_image' WHERE m_ID = '$edit_menu' ";
            ...
            <form action=" " method="post" enctype="multipart/form-data">
                ...
                <div class="col-lg-6 col-md-6">
                   <h3 class="page-header" style="text-align:center;"> UPDATE FOOD </h3>
                    ...
                    <button type="submit" id="addfood" class="btn btn-primary" name="update_menu"><span class="glyphicon glyphicon-log-in"></span> Update</button>
                </div>
            </form>
