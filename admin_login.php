        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6">
                    ...
                    <img src="images/administrator-icon-5154.png"class="img-thumbnail" alt="" >
                </div>
                <div class="col-lg-3 col-md-3"></div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <form action=" " method="post">
                    <div class="col-lg-6 col-md-6">
                        ...
                        <button type="submit" class="btn btn-primary" name="submit_admin"><span class="glyphicon glyphicon-log-in"></span> Login</button>
                        <a href="#" id="forget">forgot password?</a>
                        <button id="home" class="btn btn-default" name="submit"><a href="index.php"><i class="fa fa-arrow-circle-o-left"></i> Home</a></button>
                    </div>
                </form>
